...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.warning.setGeometry(QtCore.QRect(180, 280, 500, 500))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.zonelyellow.setPixmap(QtGui.QPixmap("images/zone1yellow2_rotated.png"))
        self.zonelyellow.setScaledContents(True)
        self.zonelyellow.setObjectName("zonelyellow")
        self.zonebred_2 = QtWidgets.QLabel(self.centralwidget)
        self.zonebred_2.setGeometry(QtCore.QRect(1310, 540, 491, 871))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.zonebred_2.sizePolicy().hasHeightForWidth())
        self.zonebred_2.setSizePolicy(sizePolicy)
        self.zonebred_2.setMinimumSize(QtCore.QSize(0, 0))
        self.zonebred_2.setMaximumSize(QtCore.QSize(500, 1000))
        self.zonebred_2.setText("")
        self.zonebred_2.setPixmap(QtGui.QPixmap("images/zone2red2_rotated.png"))
        self.zonebred_2.setScaledContents(True)
        self.zonebred_2.setObjectName("zonebred_2")
        ...
        self.zonebyellow.setPixmap(QtGui.QPixmap("images/zone2yellow2_rotated.png"))
